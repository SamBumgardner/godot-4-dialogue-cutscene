...
var cutscenes : Array[DialogueCutsceneData] = [
	preload("res://DialogueCutsceneSystem/data/cutscenes/Cutscene_01.tres"),
	preload("res://DialogueCutsceneSystem/data/cutscenes/Cutscene_02.tres"),
	preload("res://DialogueCutsceneSystem/data/cutscenes/Cutscene_03.tres"),
]
