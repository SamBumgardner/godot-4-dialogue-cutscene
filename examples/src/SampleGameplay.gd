...
var cutscenes : Array[DialogueCutsceneData] = [
	preload("res://examples/data/cutscenes/Cutscene_01.tres"),
	preload("res://examples/data/cutscenes/Cutscene_02.tres"),
	preload("res://examples/data/cutscenes/Cutscene_03.tres"),
]
